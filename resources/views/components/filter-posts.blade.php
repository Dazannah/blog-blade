<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-3">
  <div class="font-semibold text-xl leading-tight">
    <form id="filterPostForm" onsubmit="return submitFilter();">
      ...
      <button id="filterPostFormSubmit" class="py-1 px-3 border border-gray-400 hover:border-transparent hover:bg-gray-200 dark:hover:bg-gray-800 text-xl text-gray-800 dark:text-gray-200 rounded" >
